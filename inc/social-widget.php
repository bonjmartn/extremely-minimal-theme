...
class social_Widget extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      ...
      __( 'Social Icons', 'extremely-minimal-free' ), // Name
      array( 'description' => __( 'Drag me to the Social Icons widget area', 'extremely-minimal-free' ), ) // Args
    );
  }
  ...
  public function form( $instance ) {
    ...
    <p>
    <label for="<?php echo $this->get_field_id('facebook_field'); ?>"><?php _e('Enter the URL for your Facebook page', 'extremely-minimal-free'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('twitter_field'); ?>"><?php _e('Enter the URL for your Twitter profile', 'extremely-minimal-free'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('pinterest_field'); ?>"><?php _e('Enter the URL for your Pinterest page', 'extremely-minimal-free'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('instagram_field'); ?>"><?php _e('Enter the URL for your Instagram profile', 'extremely-minimal-free'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('googleplus_field'); ?>"><?php _e('Enter the URL for your Google Plus profile', 'extremely-minimal-free'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('yelp_field'); ?>"><?php _e('Enter the URL for your Yelp page', 'extremely-minimal-free'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('youtube_field'); ?>"><?php _e('Enter the URL for your YouTube page', 'extremely-minimal-free'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('linkedin_field'); ?>"><?php _e('Enter the URL for your LinkedIn profile', 'extremely-minimal-free'); ?></label>
